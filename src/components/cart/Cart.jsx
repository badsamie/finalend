      ...
      <div className="flex flex-wrap justify-center gap-4">
        {cartItems.map((item) => (
          ...
          >
            ...
            <p className="text-purple-500 font-bold">Title: {item.title}</p> {/* Добавляем информацию о заголовке */}
            <p className="text-purple-500 font-bold">Description: {item.description}</p> {/* Добавляем информацию об описании */}
            <p className="text-[12px] text-purple-500 font-bold">Location: {item.location}</p>
